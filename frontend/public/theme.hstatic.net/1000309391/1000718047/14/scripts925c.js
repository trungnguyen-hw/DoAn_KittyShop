		...
		if(cart) {
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='../../../../theme.hstatic.net/1000309391/1000718047/14/no_image.jpg?v=362'>");
...
function clone_item(product,i){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','../../../../theme.hstatic.net/1000309391/1000718047/14/no_image.jpg?v=362').attr('alt', product.url);
	} else {
